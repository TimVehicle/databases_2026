...
! [Концептуальная модель](images/logical.png)
...
Для каждой таблицы определены атрибуты, первичные и внешние ключи, ограничения `NOT NULL` и `UNIQUE`, а также подходящие типы данных PostgreSQL.

Физическая модель реализована в виде SQL-скрипта с использованием `CREATE TABLE`.
